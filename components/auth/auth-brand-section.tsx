      ...
      <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
        <div className="mb-8">
          ...
          <p className="text-xl text-slate-300 mb-8 leading-relaxed">
            Streamline your content creation, manage multiple websites, and
            boost your productivity with our comprehensive CMS platform.
          </p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">
          <p className="text-slate-400 text-sm">
            "MHhas transformed how we manage our content. The intuitive
            interface and powerful features make it a joy to use."
          </p>
