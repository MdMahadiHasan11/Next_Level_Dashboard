...
const mockPlugins: Plugin[] = [
  {
    ...
    description:
      "Tối ưu h��a SEO toàn diện cho website với các công cụ phân tích từ khóa và meta tags tự động.",
    version: "2.1.4",
  ...
  },
  {
    ...
    description:
      "Tạo và quản lý các form liên hệ với nhiều tùy chọn tùy chỉnh và tích hợp email marketing.",
    version: "1.8.2",
  ...
  },
  {
    ...
    name: "Backup Manager",
    description:
      "Sao lưu tự động dữ liệu website và cơ sở dữ liệu với lịch trình linh hoạt.",
    version: "3.0.1",
  ...
  },
  {
    ...
    description:
      "Bảng điều khiển phân tích chi tiết với biểu đồ và báo cáo thời gian thực.",
    version: "1.5.0",
  ...
  },
  {
    ...
    description:
      "Bảo vệ website khỏi các cuộc tấn công với firewall và quét malware tự động.",
    version: "2.3.1",
